      ...
      <form className="flex flex-col gap-2 w-full" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-between border-t py-2 border-t-gray-700">
          <div className="flex gap-1 items-center">
            <CiImageOn
              className="fill-purple-700 w-6 h-6 cursor-pointer"
          ...
          <button
            className="btn btn-primary bg-purple-700 border-purple-700 rounded-full btn-sm text-white px-4"
            disabled={isPending}
          >
            {isPending ? <LoadingSpinner size="small" /> : "Post"}
          </button>
        </div>
